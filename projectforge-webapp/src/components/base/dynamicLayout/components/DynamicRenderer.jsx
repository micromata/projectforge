...
import DynamicListPageTanStackGrid from './table/DynamicListPageTanStackGrid';
...
registerComponent('AG_GRID', DynamicTanStackGrid);
registerComponent('AG_GRID_LIST_PAGE', DynamicListPageTanStackGrid);
