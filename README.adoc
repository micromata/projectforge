...
1. Searches for `application.properties` in current directory.
2. Searches for `application-default.properties` in current directory.
3. Searches for `application.properties` in sub directory `config` of the current directory.
4. Searches for `application-default.properties` in sub directory `config` of the current directory.
