...
1. Searches for `./config/application-default.properties` (in current directory).
2. Searches for `./config/application.properties` (in current directory).
3. Searches for `./application-default.properties` (in current directory).
4. Searches for `./application.properties` (in current directory).
