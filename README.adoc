...
For a fast installation via docker or executable jar, please refer https://github.com/micromata/projectforge/blob/master/doc/installation.adoc[Installation].
...
The fastest way of installation of the newest version (7.0). you will find here: https://github.com/micromata/projectforge/blob/master/doc/installation.adoc[Installation]
...
Or simply use the fastest way: https://github.com/micromata/projectforge/blob/master/doc/installation.adoc[Installation as docker image]
====
