...
Please see `BookRest`[https://github.com/micromata/projectforge/blob/develop/projectforge-rest/src/main/kotlin/org/projectforge/rest/BookRest.kt]
as an example. Nothing more is needed to create a list and edit page for an entity.

There is no more code (HTML, JavaScript or anything else needed).
