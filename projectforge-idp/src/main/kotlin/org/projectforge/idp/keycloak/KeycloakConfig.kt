...
/**
 * Keycloak-specific connection properties.
 * Only active when projectforge.idp.provider=keycloak (or not set, as keycloak is the default).
 */
@Configuration
...
open class KeycloakConfig {
    ...
    /** Page size for paginated Keycloak API calls (overrides IdpConfig.pageSize if set) */
