...
class ContractRest() : AbstractStandardRest<ContractDO, ContractDO, ContractDao, ContractFilter>(ContractDao::class.java, ContractFilter::class.java, "legalAffaires.contract.title") {
    /**
