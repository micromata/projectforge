...
class DevelopmentRest() {
    ...
    fun magicFilter(): List<MagicFilter<BookFilter>> {
        ...
        filter.entries!!.add(MagicFilterEntry(field = "modifiedByUser", value = User(2, username = "fin")))
        ...
        filter.entries!!.add(MagicFilterEntry(field = "modifiedInterval", fromValue = "2019-04-28'T'17:00:05.000Z"))
