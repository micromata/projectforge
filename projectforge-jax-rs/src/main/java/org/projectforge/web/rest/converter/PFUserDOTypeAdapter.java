...
public class PFUserDOTypeAdapter implements JsonSerializer<PFUserDO>, JsonDeserializer<PFUserDO>
{
  ...
  @Override
  public synchronized JsonElement serialize(final PFUserDO user, final Type type,
      ...
      final JsonDeserializationContext jsonDeserializationContext)
  {
    ...
    return TenantRegistryMap.getInstance().getTenantRegistry().getUserGroupCache().getUser(userId);
  }
}
