...
public class UserRightIdSingleValueConverter implements SingleValueConverter
{
  ...
  UserRightIdSingleValueConverter(UserRightService userRights)
  {
    super();
  ...
  {
    return UserRightId.class.isAssignableFrom(type) || IUserRightId.class.isAssignableFrom(type);
  }
