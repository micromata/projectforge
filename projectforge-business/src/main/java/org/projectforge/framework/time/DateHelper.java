...
public class DateHelper implements Serializable {
     ...
     * @return
     */
    public static String getForTestCase(final Date date) {
        return FOR_TESTCASE_OUTPUT_FORMATTER.get().format(date);
    }

    public static String getTimestampAsFilenameSuffix() {
        return getTimestampAsFilenameSuffix(new Date());
    }

    public static String getTimestampAsFilenameSuffix(final Date date) {
        if (date == null) {
            return "--";
        }
    ...
    public static String getDateAsFilenameSuffix() {
        return getDateAsFilenameSuffix(new Date());
    }

    public static String getDateAsFilenameSuffix(final Date date) {
        if (date == null) {
            return "--";
        }
