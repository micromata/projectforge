...
/**
 * Simple class for storing a project favorite. It contains only a reference to one project.
 * @author Kai Reinhard (k.reinhard@micromata.de)
 * 
 */
public class ProjektFavorite
{
  @UserPrefParameter(i18nKey = "fibu.projekt")
