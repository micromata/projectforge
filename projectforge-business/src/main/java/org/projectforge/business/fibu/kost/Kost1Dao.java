...
public class Kost1Dao extends BaseDao<Kost1DO> {
    ...
    public Kost1DO getKost1(final int nummernkreis, final int bereich, final int teilbereich, final int endziffer) {
        return persistenceService.selectNamedSingleResult(
                ...
                Kost1DO.class,
                new Pair<>("nummernkreis", nummernkreis),
                new Pair<>("bereich", bereich),
                new Pair<>("teilbereich", teilbereich),
                new Pair<>("endziffer", endziffer));
    }
    ...
    @Override
    public void onSaveOrModify(final Kost1DO obj) {
        Kost1DO other;
        verifyKost(obj);
        if (obj.getId() == null) {
            // New entry
            ...
            other = persistenceService.selectNamedSingleResult(
                    ...
                    Kost1DO.class,
                    new Pair<>("nummernkreis", obj.getNummernkreis()),
                    new Pair<>("bereich", obj.getBereich()),
                    new Pair<>("teilbereich", obj.getTeilbereich()),
                    new Pair<>("endziffer", obj.getEndziffer()),
    ...
    @Override
    public void afterSaveOrModify(final Kost1DO kost1) {
