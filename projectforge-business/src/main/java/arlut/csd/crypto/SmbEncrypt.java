...
public class SmbEncrypt {
  ...
  static private final int bytes2u(final byte b)
  {
    return b & 0xff;
  }
  ...
  static void permute(final byte[] out, final byte[] in, final byte[] p, final int n)
  {
    for (int i=0; i<n; i++)
    {
      out[i] = in[p[i]-1];
  ...
  static void lshift(final byte[] d, final int count, final int n)
  {
  ...
  static void concat(final byte[] out, final byte[] in1, final byte[] in2, int l1, int l2)
  {
    int i = 0;
    int j = 0;
  ...
  static void xor(final byte[] out, final byte[] in1, final byte[] in2, final int n)
  {
    for (int i=0; i<n; i++)
    {
  ...
  static void dohash(final byte[] out, final byte[] in, final byte[] key, final boolean forw)
  {
    int i, j, k;
    final byte pk1[] = new byte[56];
    final byte c[] = new byte[28];
    final byte d[] = new byte[28];
    final byte cd[] = new byte[56];
    final byte ki[][] = new byte[16][48];
    final byte pd1[] = new byte[64];
    final byte l[] = new byte[32];
    final byte r[] = new byte[32];
    final byte rl[] = new byte[64];
    ...
    for (i=0; i<16; i++)
    {
      final byte er[] = new byte[48];
      final byte erk[] = new byte[48];
      final byte b[][] = new byte[8][6];
      final byte cb[] = new byte[32];
      final byte pcb[] = new byte[32];
  ...
  static void str_to_key(final byte[] str, final int str_offset, final byte[] key)
  {
    int i;
  ...
  static void smbhash(final byte[] out, final byte[] in, final byte[] key)
  {
  ...
  static void smbhash(final byte[] out, final byte[] in, final byte[] key, final boolean forw)
  {
  ...
  static void smbhash(final byte[] out, final int out_offset, final byte[] in, final int in_offset, final byte[] key, final int key_offset)
  {
  ...
  static void smbhash(final byte[] out, final int out_offset, final byte[] in, final int in_offset, final byte[] key, final int key_offset, final boolean forw)
  {
    int i;
    final byte outb[] = new byte[64];
    final byte inb[] = new byte[64];
    final byte keyb[] = new byte[64];
  ...
  static void E_P16(final byte[] p14, final byte[] p16)
  {
    final byte sp8[] = {0x4b, 0x47, 0x53, 0x21, 0x40, 0x23, 0x24, 0x25}; // KGS!@#$%
  ...
  static void E_P24(final byte[] p21, final byte[] c8, final byte[] p24)
  {
    smbhash(p24, c8, p21);
  ...
  static void D_P16(final byte[] p14, final byte[] in, final byte[] out)
  {
    smbhash(out, in, p14, false);
    smbhash(out, 8, in, 8, p14, 7, false);
  }

  static void E_old_pw_hash( final byte[] p14, final byte[] in, final byte[] out)
  {
    smbhash(out, in, p14);
    smbhash(out, 8, in, 8, p14, 7);
  }

  public static void cred_hash1(final byte[] out,final byte[] in,final byte[] key)
  {
  ...
  public static void cred_hash2(final byte[] out,final byte[] in,final byte[] key)
  {
    final byte buf[] = new byte[8];
    final byte key2[] = new byte[8];
  ...
  public static void cred_hash3(final byte[] out,final byte[] in,final byte[] key, final boolean forw)
  {
    final byte key2[] = new byte[8];
  ...
  public static void SamOEMhash(final byte[] data, final byte[] key, final boolean bigbuf)
  {
    final byte s_box[] = new byte[256];
  ...
  public static String LANMANHash(String password)
  {
    ...
    final char c_ary[] = password.toUpperCase().toCharArray();
  ...
  public static String NTUNICODEHash(String password)
  {
    ...
    final byte wpwd[] = new byte[c_ary.length * 2];

    for (int i = 0; i < c_ary.length; i++)
    {
      final char c = c_ary[i];

      wpwd[2*i] = (byte) (c & 0x00ff);
      wpwd[2*i+1] = (byte) (c & 0xff00);
    }

    final Md4 m = new Md4(wpwd);
