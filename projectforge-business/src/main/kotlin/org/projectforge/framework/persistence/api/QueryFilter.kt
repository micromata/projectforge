...
class QueryFilter @JvmOverloads constructor(filter: BaseSearchFilter? = null) {
    ...
    fun addFullTextSearch(str: String?, autoWildcardSearch: Boolean = false) {
        logDebugFunCall(log) {
            it.mtd("addFullTextSearch(str, autoWildcardSearch)")
                .params("str" to str, "autoWildcardSearch" to autoWildcardSearch)
        }
    ...
    fun setYearAndMonth(dateField: String, year: Int, month: Int) {
        logDebugFunCall(log) {
            it.mtd("setYearAndMonth(dateField, year, month)").params(
    ...
    companion object {
        ...
        fun taskSearch(field: String, taskId: Long?, recursive: Boolean): DBPredicate {
            logDebugFunCall(log) {
                it.mtd("taskSearch(field, taskId, recursive)").params(
                    "field" to field,
                    "taskId" to taskId,
