...
object NumberHelper {
    ...
    val KB_BD = BigDecimal(KILO_BYTES)
    const val MEGA_BYTES = KILO_BYTES * 1024
    val MB_BD = BigDecimal(MEGA_BYTES)
    const val GIGA_BYTES = MEGA_BYTES * 1024
    val GB_BD = BigDecimal(GIGA_BYTES)
    ...
    fun extractPhonenumber(str: String?): String? {
        val defaultCountryPhonePrefix = Configuration.getInstance().getStringValue(ConfigurationParam.DEFAULT_COUNTRY_PHONE_PREFIX)
