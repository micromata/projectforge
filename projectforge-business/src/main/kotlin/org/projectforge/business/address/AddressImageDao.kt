...
open class AddressImageDao {
     ...
     */
    open fun saveOrUpdateInTrans(addressId: Long, image: ByteArray): Boolean {
        ...
        addressDao.updateInTrans(address) // Throws an exception if the logged-in user has now access.
