...
/**
 * Filters vacation entries with status conflict.
 */
class VacationConflictsFilter : CustomResultFilter<VacationDO> {
  ...
  companion object {
    private val conflictingVacationsCache = ApplicationContextProvider.getApplicationContext().getBean(ConflictingVacationsCache::class.java)
  }
}
