...
open class VacationSendMailService {
    ...
    private fun prepareMail(
        ...
        mail.content =
            sendMail.renderGroovyTemplate(
                mail,
                "mail/vacationMail.html",
                data,
                translate(recipient, "vacation"),
                recipient
            )
        return mail
    }
    ...
    internal class VacationInfo(employeeDao: EmployeeDao, val vacation: VacationDO) {
        ...
        var periodText =
            I18nHelper.getLocalizedMessage("vacation.mail.period", startDate, endDate, workingDaysFormatted)
        ...
        fun updateI18n(recipient: PFUserDO?) {
            ...
            periodText =
                I18nHelper.getLocalizedMessage(
                    recipient,
                    "vacation.mail.period",
                    startDate,
                    endDate,
