      ...
      if (numberOfWorkingDays > stats.vacationDaysLeftInYearWithoutCarry) {
        ...
        if (year != endDate.year) { // Leave days over at least 2 years...
          ...
          val numberOfWorkingDaysInStartDate =
            VacationService.getVacationDays(vacation, startDay.beginOfYear.localDate, startDay.endOfYear.localDate)
          ...
          numberOfWorkingDays =
            VacationService.getVacationDays(vacation, endDay.beginOfYear.localDate, endDay.endOfYear.localDate)
