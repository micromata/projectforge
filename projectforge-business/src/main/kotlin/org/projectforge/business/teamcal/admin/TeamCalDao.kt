...
class TeamCalDao : BaseDao<TeamCalDO>(TeamCalDO::class.java) {
     ...
     */
    fun setFullAccessGroups(calendar: TeamCalDO, fullAccessGroups: Collection<GroupDO?>?) {
        calendar.fullAccessGroupIds = groupService.getGroupIds(fullAccessGroups)
    }

    fun getSortedFullAccessGroups(calendar: TeamCalDO): Collection<GroupDO> {
        return groupService.getSortedGroups(calendar.fullAccessGroupIds)
    }
     ...
     */
    fun setFullAccessUsers(calendar: TeamCalDO, fullAccessUsers: Collection<PFUserDO?>) {
        calendar.fullAccessUserIds = userService.getUserIds(fullAccessUsers)
    }

    fun getSortedFullAccessUsers(calendar: TeamCalDO): Collection<PFUserDO> {
        return userService.getSortedUsers(calendar.fullAccessUserIds)
    }
     ...
     */
    fun setReadonlyAccessGroups(calendar: TeamCalDO, readonlyAccessGroups: Collection<GroupDO?>?) {
        calendar.readonlyAccessGroupIds = groupService.getGroupIds(readonlyAccessGroups)
    }

    fun getSortedReadonlyAccessGroups(calendar: TeamCalDO): Collection<GroupDO> {
        return groupService.getSortedGroups(calendar.readonlyAccessGroupIds)
    }
     ...
     */
    fun setReadonlyAccessUsers(calendar: TeamCalDO, readonlyAccessUsers: Collection<PFUserDO?>) {
        calendar.readonlyAccessUserIds = userService.getUserIds(readonlyAccessUsers)
    }

    fun getSortedReadonlyAccessUsers(calendar: TeamCalDO): Collection<PFUserDO> {
        return userService.getSortedUsers(calendar.readonlyAccessUserIds)
    }
     ...
     */
    fun setMinimalAccessGroups(calendar: TeamCalDO, minimalAccessGroups: Collection<GroupDO?>?) {
        calendar.minimalAccessGroupIds = groupService.getGroupIds(minimalAccessGroups)
    }

    fun getSortedMinimalAccessGroups(calendar: TeamCalDO): Collection<GroupDO> {
        return groupService.getSortedGroups(calendar.minimalAccessGroupIds)
    }
     ...
     */
    fun setMinimalAccessUsers(calendar: TeamCalDO, minimalAccessUsers: Collection<PFUserDO?>) {
        calendar.minimalAccessUserIds = userService.getUserIds(minimalAccessUsers)
    }

    fun getSortedMinimalAccessUsers(calendar: TeamCalDO): Collection<PFUserDO> {
