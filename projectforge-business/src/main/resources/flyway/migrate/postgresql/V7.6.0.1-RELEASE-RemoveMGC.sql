...
ALTER TABLE t_fibu_eingangsrechnung_position ALTER COLUMN eingangsrechnungs_pos_fk TYPE bigint;
...
ALTER TABLE t_fibu_employee_validity_period_attr ALTER COLUMN employee_id TYPE bigint;
...
ALTER TABLE t_fibu_rechnung_position ALTER COLUMN rechnungs_pos_fk TYPE bigint;
...
ALTER TABLE t_group_task_access ALTER COLUMN group_task_access_fk TYPE bigint;
...
ALTER TABLE t_orga_visitorbook_entry ALTER COLUMN visitorbook_id TYPE bigint;
...
ALTER TABLE t_plugin_calendar_event ALTER COLUMN team_event_fk TYPE bigint;
ALTER TABLE t_plugin_calendar_event ALTER COLUMN team_event_fk2 TYPE bigint;
...
ALTER TABLE t_user_pref ALTER COLUMN user_pref_fk TYPE bigint;
