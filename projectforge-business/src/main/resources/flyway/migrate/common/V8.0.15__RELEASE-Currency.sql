-- Add currency columns to invoice tables
ALTER TABLE t_fibu_rechnung ADD COLUMN currency VARCHAR(10);
ALTER TABLE t_fibu_eingangsrechnung ADD COLUMN currency VARCHAR(10);
