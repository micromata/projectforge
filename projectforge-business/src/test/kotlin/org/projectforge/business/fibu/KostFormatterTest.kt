...
class KostFormatterTest : AbstractTestBase() {
    ...
    fun testFormatting() {
        ...
        Assertions.assertEquals("204 - ACME very long name of the company with a lot of te...", kostFormatter.formatKunde(kunde, KostFormatter.FormatType.NUMBER_AND_NAME))
