...
class UserPrefTest : AbstractTestBase() {
    ...
    fun jsonTest() {
        ...
        userPref.name = ""
        val id = userPrefDao.insert(userPref)
        userPref = userPrefDao.find(id, checkAccess = false)
    ...
    fun convertPrefParameters() {
        ...
        persistenceService.runInTransaction { _ ->
            ...
            task = initTestDB.addTask("UserPrefTest", "root")
            ...
            id = userPrefDao.insert(userPref)
