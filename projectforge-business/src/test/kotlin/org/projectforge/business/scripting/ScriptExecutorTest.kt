...
class ScriptExecutorTest {
    ...
    fun createValidIdentifierTest() {
        Assertions.assertEquals(ScriptExecutor.createValidIdentifier(null), "_null_")
        Assertions.assertEquals(ScriptExecutor.createValidIdentifier(""), "_empty_")
        Assertions.assertEquals(ScriptExecutor.createValidIdentifier("i"), "i")
        Assertions.assertEquals(ScriptExecutor.createValidIdentifier("I"), "i")
        Assertions.assertEquals(ScriptExecutor.createValidIdentifier("5"), "_")
        Assertions.assertEquals(ScriptExecutor.createValidIdentifier("55"), "_5")
        Assertions.assertEquals(ScriptExecutor.createValidIdentifier("Hello world!"), "hello_world_")
    }
