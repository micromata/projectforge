...
public class GanttTest
{
  ...
  private GanttTask createTestChart()
  {
    ...
    task1.setStartDate(day.getLocalDate());
    ...
    task5.setStartDate(day.getLocalDate());
    ...
    task12.setStartDate(day.getLocalDate());
    ...
    task16.setStartDate(day.getLocalDate());
    return phase1;
  }
  ...
  private void assertDate(final int year, final Month month, final int day, final LocalDate date)
  {
    final PFDay dh = PFDay.from(date);
