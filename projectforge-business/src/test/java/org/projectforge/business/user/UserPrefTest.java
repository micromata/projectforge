...
public class UserPrefTest extends AbstractTestBase {
    ...
    void saveAndUpdateTest() {
        persistenceService.runInTransaction(context -> {
            ...
            userPref = userPrefDao.internalQuery(loggedInUser.getId(), "TEST_AREA3", "", context);
            ...
            userPref.setName("");
            userPrefDao.internalSaveOrUpdate(userPref, context);
            userPref = userPrefDao.internalQuery(loggedInUser.getId(), "TEST_AREA4", "", context);
            assertTrue(CollectionUtils.isEmpty(userPref.getUserPrefEntries()));
    ...
    public void convertPrefParameters() {
        ...
        persistenceService.runInTransaction(context -> {
            ...
            final TaskDO task = initTestDB.addTask("UserPrefTest", "root", context);
            ...
            final Serializable id = userPrefDao.save(userPref, context);
