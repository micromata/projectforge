...
public class DatabaseUpdateDaoTest extends AbstractTestBase
{
  ...
  public void createTableScript()
  {
    ...
    myDatabaseUpdater.setConfiguration(config);
  ...
  public void buildAddUniqueConstraint()
  {
    final StringBuffer buf = new StringBuffer();
    final MyDatabaseUpdateService databaseUpdateDao = myDatabaseUpdater.getDatabaseUpdateService();
    databaseUpdateDao.buildAddUniqueConstraintStatement(buf, "t_user_right", "t_user_right_user_fk_key", "user_fk",
        "right_id");
  ...
  public void buildAddTableColumn()
  {
    ...
    final StringBuffer buf = new StringBuffer();
    final MyDatabaseUpdateService databaseUpdateDao = myDatabaseUpdater.getDatabaseUpdateService();
    databaseUpdateDao.buildAddTableAttributesStatement(buf, "t_task",
  ...
  public void createAndDropTableColumn()
  {
    logon(ADMIN);
    final MyDatabaseUpdateService databaseUpdateDao = myDatabaseUpdater.getDatabaseUpdateService();
    databaseUpdateDao.addTableAttributes("t_task", new TableAttribute("test1", TableAttributeType.DATE),
