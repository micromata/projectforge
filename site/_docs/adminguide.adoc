...
projectforge.2fa.expiryPeriod.hours1=ADMIN-WRITE;MY_ACCOUNT;SCRIPT-WRITE
projectforge.2fa.expiryPeriod.hours8=ADMIN;SCRIPT;FINANCE-WRITE;ORGA-WRITE;HR-WRITE;
