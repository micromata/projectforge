...
Install
PostgreSQL http://web.archive.org/web/20210119121809/https://www.postgresql.org/download/[here] or
via `brew install postgresql`. [.short_text]##For easy management of
their
database## use http://web.archive.org/web/20210119121809/https://www.pgadmin.org/download/index.php[pgAdmin].
...
information http://web.archive.org/web/20210119121809/http://docs.spring.io/spring-boot/docs/current/reference/html/common-application-properties.html[here].

The format of the file is:

*File:* `application.properties`:
http://web.archive.org/web/20210119121809/https://github.com/micromata/projectforge/blob/master/projectforge-application/application.properties[here]
...
[source,tw-data-text,tw-ta,tw-text-small]
----
...
page.[.confluence-embedded-file-wrapper]##

[cols=",",]
|===
|Figure 1: |_You can initiate a phone call by simply clicking on a phone
...
number.[.confluence-embedded-file-wrapper]##

[cols=",",]
|===
|Figure 2: |_You can send text messages by simply clicking on the SMS
symbol of an address or by entering a name or cell phone number._
|===
...
|===
|1 +
2 |include /sw/etc/openldap/schema/cosine.schema +
...
[cols=",",]
|===
|Figure 3: |_ProjectForge uses the fields and object classes shown in
...
(see http://web.archive.org/web/20210119121809/https://www.projectforge.org/pf-common/Administration_Guide#section4.11.5.2[4.11.5.2] ).
...
syncronization). So the renaming of user names should work._
|===

[width="100%",cols="50%,50%",]
|===
|Figure 4: |_ProjectForge uses the fields and object classes shown in
...
[cols=",",]
|===
|Figure 5: |_ProjectForge is able to manage POSIX accounts in LDAP
master mode._
|===
...
in `application.properties`) followed by the user-name: e.
g. `/home/kai`
...
[cols=",",]
|===
|Figure 6: |_ProjectForge is able to manage POSIX and Samba accounts in
LDAP master mode._
|===
...
ProjectForge provides a very convenient method for updating to new
versions (improved again since version 3.5.2). Please call the menu
"Update system".

[cols=",",]
|===
|Figure 7: |_ProjectForge provides a convenient method for system
updates. The data base scheme will be updated and the data base will be
migrated automatically by scripts._
|===

This dialog is called automatically on start-up if a new
ProjectForge-Release detects something to up-date. Please select the
check-box "Show old updates" to see, that your ProjectForge is
completely up-to-date. You can update from any older version.
...
[[XML-backup and restore and data-base migration]]
...
[.confluence-embedded-file-wrapper]##image:http://web.archive.org/web/20210119121809im_/https://www.projectforge.org/files/projectforge_content/images/light32.gif[image]##**Hint**
...
see http://web.archive.org/web/20210119121809/https://www.projectforge.org/pf-common/Administration_Guide#section3.3.3[3.3.3] .  +
Don't forget to create indices
(see http://web.archive.org/web/20210119121809/https://www.projectforge.org/pf-common/Administration_Guide#section3.4[3.4] )!
...
|===
|
|update t_pf_user SET password='SHA\{BC871652288E56E306CFA093BEFC3FFCD0ED8872}', email='m.developer@http://web.archive.org/web/20210119121809/http://acme.com/[acme.com]';
|===
____
...
http://web.archive.org/web/20210119121809/https://www.projectforge.org/files/projectforge_content/images/Configurable_Attributes_Screenshot.png[[.confluence-embedded-file-wrapper .confluence-embedded-manual-size]#image:http://web.archive.org/web/20210119121809im_/https://www.projectforge.org/files/projectforge_content/images/Configurable_Attributes_Screenshot.png[image,width=500]#]
...
key (see
http://web.archive.org/web/20210119121809/https://www.projectforge.org/pf-en/i18n[i18n]).
