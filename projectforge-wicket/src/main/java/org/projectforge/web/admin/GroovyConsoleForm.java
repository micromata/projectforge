...
public class GroovyConsoleForm extends AbstractStandardForm<GroovyConsoleForm, GroovyConsolePage>
{
  ...
  public GroovyConsoleForm(final GroovyConsolePage parentPage)
  {
    super(parentPage);
  }
  ...
  protected void init()
  {
    ...
    {
      final FieldsetPanel fs = gridBuilder.newFieldset("Groovy");
    ...
    }
    {
      ...
      final SingleButtonPanel buttonPanel = new SingleButtonPanel(fs.newChildId(), button, "execute",
