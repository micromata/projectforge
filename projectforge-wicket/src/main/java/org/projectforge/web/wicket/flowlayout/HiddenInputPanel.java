 ...
 * 
 */
public class HiddenInputPanel extends Panel implements ComponentWrapperPanel
{
  ...
  public HiddenInputPanel(final String id, final Component field)
  {
    super(id);
    add(field);
    this.field = field;
   ...
   */
  public HiddenInputPanel setHtmlId(final String id)
  {
    field.setMarkupId(id).setOutputMarkupId(true);
    return this;
  }
