...
public class DataObjectSortableDataProvider<T extends IdObject<?>> extends SortableDataProvider<T, String>
{
  ...
  public DataObjectSortableDataProvider(final SortParam<String> sortParam, final Supplier<List<T>> supplier)
  {
  ...
  public DataObjectSortableDataProvider<T> setCompleteList(final List<T> completeList)
  {
