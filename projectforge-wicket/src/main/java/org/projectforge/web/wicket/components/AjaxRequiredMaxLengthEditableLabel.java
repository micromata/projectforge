...
public class AjaxRequiredMaxLengthEditableLabel extends AjaxMaxLengthEditableLabel
{
   ...
   */
  public AjaxRequiredMaxLengthEditableLabel(final String id, final IModel<String> model)
  {
    super(id, model);
    setRequired(true);
  }
   ...
   * @see MaxLengthTextField#MaxLengthTextField(WebMarkupContainer, String,PropertyModel)
   */
  public AjaxRequiredMaxLengthEditableLabel(final String id, final IModel<String> model, final int maxLength)
  {
