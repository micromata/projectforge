...
{
  private static final org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(WicketHtmlHelper.class);

  private static WicketHtmlHelper instance = new WicketHtmlHelper();
  ...
  public static String getImageTag(final RequestCycle requestCycle, final String src)
  {
    final StringBuffer buf = new StringBuffer();
  ...
  public static WicketHtmlHelper appendImageTag(final RequestCycle requestCycle, final StringBuffer buf,
      final String src,
      final String width,
      final String height)
  {
   ...
   * @return
   */
  public static WicketHtmlHelper appendAncorStartTag(final RequestCycle requestCycle, final StringBuffer buf,
      final String href)
  {
   ...
   * @return
   */
  public static WicketHtmlHelper appendAncorOnClickSubmitEventStartTag(final StringBuffer buf, final String method,
      final String... params)
  {
  ...
  public static WicketHtmlHelper appendAncorEndTag(final StringBuffer buf)
  {
    buf.append("</a>");
    return instance;
  }
