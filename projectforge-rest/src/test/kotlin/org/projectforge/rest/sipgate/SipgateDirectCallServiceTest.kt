...
class SipgateDirectCallServiceTest {
    ...
    fun getCallerData() {
        ...
        var callData: SipgateDirectCallService.CallData? = null
        TestUtils.suppressErrorLogs {
            callData = SipgateDirectCallService.getCallerData(
                emptyList(), emptyList(), "", "012345", user, "099999999",
                "0777777", "55555"
            )
        }
        Assertions.assertNull(callData, "Neither device nor defaultDevice found.")
    }
