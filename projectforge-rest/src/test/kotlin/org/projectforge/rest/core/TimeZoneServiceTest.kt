...
class TimeZoneServiceTest {
    ...
    /**
     * Test of moment timezones (17/07.2019) weather they are known and supported by Java or not.
     */
    @Test
    fun testMomentTimezones() {
        val oldTimeZone = TimeZone.getDefault()
        val utcTimeZone = TimeZone.getTimeZone("UTC")
        TimeZone.setDefault(utcTimeZone)
        momentTimeZones.forEach {
            val tz = TimeZone.getTimeZone(it)
            if (it != "UTC") {
                assertNotEquals(utcTimeZone, tz)
            }
        }
