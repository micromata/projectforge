...
class DevelopmentRest() {
    ...
    fun magicFilter(): List<MagicFilter<BaseSearchFilter>> {
        val list = mutableListOf<MagicFilter<BaseSearchFilter>>()

        var filter = MagicFilter<BaseSearchFilter>(entries = mutableListOf())
