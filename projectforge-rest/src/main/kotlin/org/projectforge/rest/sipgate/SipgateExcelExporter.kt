...
object SipgateExcelExporter {
  ...
  private fun addAddressesSheet(context: Context) {
    ...
    ExcelUtils.registerColumn(sheet, SipgateAddress::country, logErrorIfPropertyInfoNotFound = false)
    ExcelUtils.registerColumn(sheet, SipgateAddress::extendedAddress, logErrorIfPropertyInfoNotFound = false)
    ExcelUtils.registerColumn(sheet, SipgateAddress::streetAddress, logErrorIfPropertyInfoNotFound = false)
    ExcelUtils.registerColumn(sheet, SipgateAddress::poBox, logErrorIfPropertyInfoNotFound = false)
    ExcelUtils.registerColumn(sheet, SipgateAddress::postalCode, logErrorIfPropertyInfoNotFound = false)
    ExcelUtils.registerColumn(sheet, SipgateAddress::locality, logErrorIfPropertyInfoNotFound = false)
    ExcelUtils.registerColumn(sheet, SipgateAddress::region, logErrorIfPropertyInfoNotFound = false)
    ExcelUtils.addHeadRow(sheet, context.boldStyle)
