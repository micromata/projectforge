 ...
 */
class ExecuteAsUser internal constructor(val executeAsUser: PFUserDO, val scriptDO: ScriptDO) {
  /**
  ...
  fun proceedAsSuperUser(securityQuestion: String) {
    ...
    val user = PFUserDO.createCopyWithoutSecretFields(executeAsUser)!!
    ...
    ThreadLocalUserContext.setUser(executeAsUser)
  }
