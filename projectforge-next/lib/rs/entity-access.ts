 ...
 * built page passes none (see `Auftrag.writeAccess`, filled by `OrderEntityRest.transformFromDB`). So
 * the flags are fields of the entity, and an entity that doesn't carry them says nothing — which is
 * read as "allowed" here, exactly as before these flags existed.
 *
