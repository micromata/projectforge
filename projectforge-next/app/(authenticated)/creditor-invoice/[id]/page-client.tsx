...
export function CreditorInvoiceEditPageClient() {
  const raw = useRouteParams<{ id: string }>("/creditor-invoice/[id]")?.id;
  ...
  return (
    <PageShell>
      <EntityEditPage page={CREDITOR_INVOICE_PAGE} id={isNew ? null : id} />
    </PageShell>
  );
}
