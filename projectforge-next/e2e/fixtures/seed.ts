...
/**
 * `TaskDO` of the root, whose id is 1 (`ProjectForgeRoot`).
 *
 * A task always needs a parent — the backend refuses one without ("task.error.parentTaskNotFound"),
 * and the root itself is not part of the tree the page renders.
 */
