...
enum class InventoryRightId(override val id: String, override val orderString: String?, override val i18nKey: String?)
    : IUserRightId {
    // orderString and i18nKey may be null, because this right is not configurable for an user.
    PLUGIN_INVENTORY("PLUGIN_INVENTORY", null, null);
}
