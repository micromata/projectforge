...
public enum LiquidityplanningPluginUserRightId implements IUserRightId
{
  PLUGIN_LIQUIDITY_PLANNING("PLUGIN_LIQUIDITY_PLANNING", "fibu10",
  ...
  public static class ProviderService implements RightRightIdProviderService
  {
    ...
    {
      return Arrays.asList(LiquidityplanningPluginUserRightId.values());
    }
  }
