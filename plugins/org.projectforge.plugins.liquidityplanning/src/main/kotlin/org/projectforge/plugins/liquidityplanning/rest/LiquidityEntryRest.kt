...
class LiquidityEntryRest: AbstractDORest<LiquidityEntryDO, LiquidityEntryDao>(baseDaoClazz = LiquidityEntryDao::class.java, i18nKeyPrefix = "plugins.liquidityplanning.entry.title") {
     ...
     * LAYOUT Edit page
     */
    override fun createEditLayout(dto: LiquidityEntryDO): UILayout {
