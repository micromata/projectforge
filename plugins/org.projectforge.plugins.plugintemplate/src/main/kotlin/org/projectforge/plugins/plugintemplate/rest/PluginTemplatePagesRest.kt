...
class PluginTemplatePagesRest: AbstractDOPagesRest<PluginTemplateDO, PluginTemplateDao>(baseDaoClazz = PluginTemplateDao::class.java, i18nKeyPrefix = "plugins.plugintemplate.title") {
