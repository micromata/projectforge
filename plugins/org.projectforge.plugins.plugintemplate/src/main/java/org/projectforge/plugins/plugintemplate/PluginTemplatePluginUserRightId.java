...
public enum PluginTemplatePluginUserRightId implements IUserRightId
{
  PLUGIN_PLUGINTEMPLATE("PLUGIN_PLUGINTEMPLATE", "plugin50", "plugins.plugintemplate");
  ...
  public static class ProviderService implements RightRightIdProviderService
  {
    ...
    {
      return Arrays.asList(PluginTemplatePluginUserRightId.values());
    }
  }
   ...
   * @param i18nKey
   */
  private PluginTemplatePluginUserRightId(final String id, final String orderString, final String i18nKey)
  {
    this.id = id;
