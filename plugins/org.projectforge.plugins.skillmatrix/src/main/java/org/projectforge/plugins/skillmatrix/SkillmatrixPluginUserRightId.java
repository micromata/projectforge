...
public enum SkillmatrixPluginUserRightId implements IUserRightId
{
  PLUGIN_SKILL_MATRIX_SKILL("PLUGIN_SKILL_MATRIX_SKILL", "plugin20",
      "plugins.skillmatrix.skill"),

  PLUGIN_SKILL_MATRIX_SKILL_RATING(
      "PLUGIN_SKILL_MATRIX_SKILL_RATING", "plugin20",
      "plugins.skillmatrix.skillrating"),

  PLUGIN_SKILL_MATRIX_TRAINING_ATTENDEE("PLUGIN_SKILL_MATRIX_TRAINING_ATTENDEE", "plugin20",
      "plugins.skillmatrix.training"),

  PLUGIN_SKILL_MATRIX_TRAINING("PLUGIN_SKILL_MATRIX_TRAINING", "plugin20", "plugins.skillmatrix.training");
  ...
  public static class ProviderService implements RightRightIdProviderService
  {
    ...
    {
      return Arrays.asList(SkillmatrixPluginUserRightId.values());
    }
  }
