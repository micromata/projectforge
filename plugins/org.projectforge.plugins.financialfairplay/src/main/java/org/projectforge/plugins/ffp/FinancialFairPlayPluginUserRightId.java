...
public enum FinancialFairPlayPluginUserRightId implements IUserRightId
{
  PLUGIN_FINANCIALFAIRPLAY("PLUGIN_FINANCIALFAIRPLAY", "plugin40", "plugins.financialfairplay");
  public static class ProviderService implements RightRightIdProviderService
  {
    @Override
    public Collection<IUserRightId> getUserRightIds()
    {
      return Arrays.asList(FinancialFairPlayPluginUserRightId.values());
    }
  }
   ...
   * @param i18nKey
   */
  private FinancialFairPlayPluginUserRightId(final String id, final String orderString, final String i18nKey)
  {
    this.id = id;
