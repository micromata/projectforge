...
public enum IHKPluginUserRightId implements IUserRightId
{
  ...
  public static class ProviderService implements RightRightIdProviderService
  {
    ...
    {
      return Arrays.asList(IHKPluginUserRightId.values());
    }
  }
   ...
   * @param i18nKey
   */
  IHKPluginUserRightId(final String id, final String orderString, final String i18nKey)
  {
    this.id = id;
