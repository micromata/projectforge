...
public class IhkExportRightNew extends UserRightAccessCheck<TimesheetDO>
{
  public IhkExportRightNew(AccessChecker accessChecker)
  {
    super(accessChecker, IhkExportPluginUserRightIdNew.PLUGIN_IHKEXPORT, UserRightCategory.PLUGINS, UserRightValue.TRUE);
  }
