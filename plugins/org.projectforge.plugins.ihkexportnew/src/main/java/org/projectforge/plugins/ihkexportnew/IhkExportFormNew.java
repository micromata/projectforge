...
public class IhkExportFormNew extends AbstractStandardForm<Object, IhkExportPageNew>
{
  private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(IhkExportFormNew.class);
  ...
  public IhkExportFormNew(IhkExportPageNew parentPage)
  {
    super(parentPage);
  }
  ...
  protected void init()
  {
    ...
    fs.add(new DivTextPanel(fs.newChildId(), new Model<String>()
    {
      ...
      {
        return WicketUtils.getCalendarWeeks(IhkExportFormNew.this, timePeriod.getFromDate(), timePeriod.getToDate());
      }
    }));
    ...
    fs.add(new SingleButtonPanel(fs.newChildId(), downloadButton,
        getString("plugins.ihkexportNew.download"), SingleButtonPanel.DEFAULT_SUBMIT));
  }
