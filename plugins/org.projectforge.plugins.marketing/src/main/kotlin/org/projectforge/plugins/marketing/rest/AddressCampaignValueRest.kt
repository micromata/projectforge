...
class AddressCampaignValueRest: AbstractDORest<AddressCampaignValueDO, AddressCampaignValueDao>(baseDaoClazz = AddressCampaignValueDao::class.java, i18nKeyPrefix = "plugins.marketing.addressCampaignValue.title") {
