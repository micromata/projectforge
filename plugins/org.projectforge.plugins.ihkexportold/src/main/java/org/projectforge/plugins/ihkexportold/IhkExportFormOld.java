...
public class IhkExportFormOld extends AbstractStandardForm<Object, IhkExportPageOld>
{
  private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(IhkExportFormOld.class);
  ...
  public IhkExportFormOld(IhkExportPageOld parentPage) { super(parentPage); }
  ...
  protected void init()
  {
    ...
    fs.add(new DivTextPanel(fs.newChildId(), new Model<String>()
    {
      ...
      {
        return WicketUtils.getCalendarWeeks(IhkExportFormOld.this, timePeriod.getFromDate(), timePeriod.getToDate());
      }
    }));
    ...
    fs.add(new SingleButtonPanel(fs.newChildId(), downloadButton,
        getString("plugins.ihkexportOld.download"), SingleButtonPanel.DEFAULT_SUBMIT));
  }
