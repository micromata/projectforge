...
public enum IhkExportPluginUserRightIdOld implements IUserRightId
{
  PLUGIN_IHKEXPORT("PLUGIN_IHKEXPORTOLD", "plugin20", "plugins.ihkexportOld");
  public static class ProviderService implements RightRightIdProviderService
  {
    @Override
    public Collection<IUserRightId> getUserRightIds()
    {
      return Arrays.asList(IhkExportPluginUserRightIdOld.values());
    }
  }
   ...
   * @param i18nKey
   */
  private IhkExportPluginUserRightIdOld(final String id, final String orderString, final String i18nKey)
  {
    this.id = id;
