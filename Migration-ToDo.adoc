Aktuell:
- Abgeschlossene Auftrage: to be invoiced (unabhängig von Position)
- Auftragspositionen, die lt. PaymentSchedule zu fakturieren sind, sind nicht toBeInvoiced.
- Suche nach Auftragsnummern in Auftragsliste
- to be invoiced count in Auftrag
- Update caches after single load or modification.
- LiquidityList: es wird gefetched wie blöde.
- Forecast in Auftragslist fehlerhaft
- Kostzuweisungsexport: es wird gefetched wie blöde.
...
- Test: Kostzuweisungsexport, Rechnungserzeugung
